            ...
            if piece.type == "king" and piece.color == "white" and (
                ...
                if self.board.grid[7][0] is not None and self.board.grid[7][0].type == "rook" and self.board.grid[7][
                    0].color == "white" and piece.move == 0 and self.board.grid[7][1] is None and \
                        self.board.grid[7][2] is None and self.board.grid[row][col].type == "rook": # Si la tour n'a pas bougé et que les cases entre le roi et la tour sont vides
                    self.board.grid[7][0] = None # On vide la case de départ de la tour
                    self.board.grid[7][3] = None # On vide la case de départ du roi
                    self.board.grid[7][2] = Piece('white', ROOK_WHITE_IMG, "rook", 21, 7, 2,0) # On place la tour sur la case d'arrivée
                    self.board.grid[7][1] = Piece('white', KING_WHITE_IMG, "king", 5, 7, 3,0) # On place le roi sur la case d'arrivée
                    self.selected_piece = None  # On déselectionne la pièce
                if self.board.grid[7][7] is not None and self.board.grid[7][7].type == "rook" and self.board.grid[7][
                    7].color == "white" and piece.move == 0 and self.board.grid[7][6] is None and \
                        self.board.grid[7][5] is None and self.board.grid[row][col].type == "rook": # Si la tour n'a pas bougé et que les cases entre le roi et la tour sont vides
                    self.board.grid[7][7] = None # On vide la case de départ de la tour
                    self.board.grid[7][3] = None # On vide la case de départ du roi
                    self.board.grid[7][4] = Piece('white', ROOK_WHITE_IMG, "rook", 21, 7, 6,0) # On place la tour sur la case d'arrivée
                    self.board.grid[7][5] = Piece('white', KING_WHITE_IMG, "king", 5, 7, 5,0) # On place le roi sur la case d'arrivée
                    self.selected_piece = None  # On déselectionne la pièce
            if piece.type == "king" and piece.color == "black" and (
                ...
                if self.board.grid[0][0] is not None and self.board.grid[0][0].type == "rook" and self.board.grid[0][
                    0].color == "black" and piece.move == 0 and self.board.grid[0][1] is None and \
                        self.board.grid[0][2] is None: # Si la tour n'a pas bougé et que les cases entre le roi et la tour sont vides
                    self.board.grid[0][0] = None # On vide la case de départ de la tour
                    self.board.grid[0][3] = None # On vide la case de départ du roi
                    self.board.grid[0][2] = Piece('black', ROOK_BLACK_IMG, "rook", 7, 0, 2,0) # On place la tour sur la case d'arrivée
                    self.board.grid[0][1] = Piece('black', KING_BLACK_IMG, "king", 23, 0, 3,0) # On place le roi sur la case d'arrivée
                    self.selected_piece = None # On déselectionne la pièce
                if self.board.grid[0][7] is not None and self.board.grid[0][7].type == "rook" and self.board.grid[0][
                    7].color == "black" and piece.move == 0 and self.board.grid[0][6] is None and \
                        self.board.grid[0][5] is None: # Si la tour n'a pas bougé et que les cases entre le roi et la tour sont vides
                    self.board.grid[0][7] = None # On vide la case de départ de la tour
                    self.board.grid[0][3] = None # On vide la case de départ du roi
                    self.board.grid[0][4] = Piece('black', ROOK_BLACK_IMG, "rook", 7, 0, 6,0) # On place la tour sur la case d'arrivée
                    self.board.grid[0][5] = Piece('black', KING_BLACK_IMG, "king", 23, 0, 5,0) # On place le roi sur la case d'arrivée
                    self.selected_piece = None # On déselectionne la pièce
